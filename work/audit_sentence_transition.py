...
def main():
    ...
    saved,info=Checkpoints('outputs/sequential-v6/best').load(); m.load_state_dict(saved['model'])
    ...
    atomic_json('outputs/sequential-v6/transition-audit-raw.json',rows)
    atomic_json('outputs/sequential-v6/transition-audit.json',summary); print(json.dumps(summary,indent=2))
